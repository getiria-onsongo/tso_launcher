...
LOAD DATA LOCAL INFILE 'control_bwa_no_dup' INTO TABLE cnv_control_name_bwa_pileup_no_dup FIELDS TERMINATED BY '\t';
...
LOAD DATA LOCAL INFILE 'control_bwa' INTO TABLE cnv_control_name_bwa_pileup FIELDS TERMINATED BY '\t';
...
LOAD DATA LOCAL INFILE 'control_bowtie' INTO TABLE cnv_control_name_bowtie_pileup FIELDS TERMINATED BY '\t';
